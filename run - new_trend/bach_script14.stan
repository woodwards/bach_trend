...
transformed parameters { // additional parameters to be used by the model
  ...
  chem1fastb2 = chem1fastrawb1 * 2;
  chem1medb2 = chem1medrawb1 * 2;
  chem1slowb2 = chem1slowrawb1 * 2;
  chem2fastb2 = chem2fastrawb1 * 12;
  chem2medb2 = chem2medrawb1 * 12;
  chem2slowb2 = chem2slowrawb1 * 12;
