  ...
  if (file.exists(file_name)) {
    ...
    if (FALSE) {
      ...
      for (Solute in c("TP", "TN")) {
        ...
        Daily <- readUserDaily(getwd(), "temp_egret_daily.csv", qUnit = 2)
